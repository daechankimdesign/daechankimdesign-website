...
// The opaque page card (z-10) that sits over the fixed reveal-footer (z-0). The
// shadow is structural to the footer-reveal seam; the bottom edge is square.
const CARD_CLASS =
  "flex flex-1 flex-col bg-canvas relative shadow-[0_18px_40px_-16px_rgba(0,0,0,0.45)]";
