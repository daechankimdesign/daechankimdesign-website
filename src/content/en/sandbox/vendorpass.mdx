  ...
  items={[
    {
      ...
      alt: "The vendor detail modal at Tier 1: Fresh Coat Painting badged Unverified in gray, with business license, W-9, and certificate of insurance all Not uploaded",
      width: 1800,
      height: 1125,
    },
    {
      ...
      alt: "The same modal at Tier 3: a verified vendor with business license, W-9, and certificate of insurance each badged Verified in saturated blue",
      width: 1800,
      height: 1125,
    },
  ]}
  caption="One modal, two trust levels. Unverified reads gray with every document Not uploaded; Tier 3 Verified reads in saturated blue with each certificate confirmed, so visual weight tracks compliance at a glance."
/>
