...
<VideoPlayer
  ...
  caption="missionoria.com in one pass — an institution launches a campaign from its dashboard, shares the link, and a neighbor answers back in text, audio, or video."
/>
...
<MDXImage
  ...
  alt="Answering a campaign question on Oria"
  width={1800}
  height={1012}
  caption="A neighbor answers a prompt in their own words, with one-tap options to record audio or video or add photos."
/>
...
<VideoPlayer
  ...
  caption="Picking a campaign on missionoria.com, then answering its prompts — text here, with audio, video, or a photo a tap away."
/>
...
<MDXImage
  ...
  alt="A published story collection on missionoria.com"
  width={1800}
  height={1095}
  caption="A published collection on missionoria.com — a community's stories gathered in one place, open for neighbors to read and add their own."
/>
